...
| select/enter&nbsp;key<br>touchscreen&nbsp;tap/swipe&nbsp;left| A solid indicator means that lower-level views are available and can be opened.<br><br>A dotted indicator means that multiple variants exist for the current view. Pressing the key cycles through them, with the active variant highlighted.<br><br><img src="screenshots/input_enter_simple_44px.png"/> Lower-level view &nbsp;&nbsp;&nbsp; <img src="screenshots/input_enter_variants_44px.png"/> Multiple variants |
...
| Version | Changes |
|--------:|-------------|
| **v2.0.2** | Fixed select button indicator alignment on Forerunner 165, 265, 570, 965, and 970 models [ticket #171](https://github.com/METIQ-Solutions/evcc-garmin/issues/171)
| **v2.0.1** | Added support for Forerunner 70, 170, and 170 Music [ticket #168](https://github.com/METIQ-Solutions/evcc-garmin/issues/168)
