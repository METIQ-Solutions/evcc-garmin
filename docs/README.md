...
| select/enter&nbsp;key<br>touchscreen&nbsp;tap/swipe&nbsp;left| A solid indicator means that lower-level views are available and can be opened.<br><br>A dotted indicator means that multiple variants exist for the current view. Pressing the key cycles through them, with the active variant highlighted.<br><br>The indicators are shown on both touch and non-touch devices. On touch devices, you can also tap the screen or swipe left.<br><br><table><tr><td align="center"><img src="screenshots/input_enter_simple_44px.png"/><br><small>Lower-level view</small></td><td width="24px"></td><td align="center"><img src="screenshots/input_enter_variants_44px.png"/><br><small>Multiple variants</small></td></tr></table> |
