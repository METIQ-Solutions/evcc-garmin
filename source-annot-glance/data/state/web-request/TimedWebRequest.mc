...
// This class extends WebRequest with a timer that regularly
...
// at the same time, and that is managed in a the separate class EvccMultiWebRequestsHandler.

(:glance) class TimedWebRequest extends WebRequest {

    private var _timer as Timer.Timer?;

    function initialize( siteIndex as Number ) {
        WebRequest.initialize( siteIndex );
    }
