...
(:glance :background) class StateStoreBackground {
    ...
    public static function persistJson( json as JsonObject, timestamp as Moment, siteIndex as Number ) as Void {
        ...
        Storage.setValue( Constants.STORAGE_SITE_PREFIX + siteIndex, siteData as Lang.Dictionary<Storage.KeyType, Storage.ValueType> );
    }
}