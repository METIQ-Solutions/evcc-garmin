...
// The main delegate functionality is implemented in ViewCarouselDelegateBase
...
(:exclForSwipeLeftDefault) class ViewCarouselDelegate extends ViewCarouselDelegateBase {
    ...
    public function onKey( keyEvent ) as Boolean {
        ...
        if( _onNextPage ) {
            ...
            return ViewCarouselDelegateBase.onKey( keyEvent );
        }
    }
    ...
    public function onSwipe( swipeEvent ) as Boolean {
        ...
        if( swipeEvent.getDirection() == SWIPE_LEFT ) {
            ...
            return ViewCarouselDelegateBase.onSwipe( swipeEvent );
        }
    }
    ...
    public function onNextPage() as Boolean {
        if( _onNextPage ) {
            _onNextPage = false;
            return ViewCarouselDelegateBase.onNextPage();
        } else {
            _onNextPage = true;
            return false;
        }
