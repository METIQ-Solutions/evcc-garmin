...
// Similar to SiteContent it separates:
...
class SiteShell {
    ...
    public function prepare( calcDc as EvccDcInterface ) as Void {
        ...
        var font = WidgetResourceSet.FONT_XTINY;
        ...
        var header = new VerticalBlock( { :dc => calcDc, :font => font, :marginTop => spacing } );
        ...
        if( pageTitle != null || pageIcon != null ) {
            if( hasSiteTitle ) {
                ...
                */
                ...
                // largest available
                if( pageIcon != null ) {
                    pageIcon.setOption( :font, WidgetResourceSet.FONT_MEDIUM );
        ...
        // Draw the logo
        var logo = new BitmapBlock( Rez.Drawables.logo_evcc, { :marginTop => spacing, :marginBottom => spacing } );
    ...
    public function drawHeaderAndLogo( dc as Dc, clear as Boolean ) as Void {
        ...
        ( _header as VerticalBlock ).drawPrepared( dc );
        ( _logo as BitmapBlock ).drawPrepared( dc );
        if( clear ) {
            _header = null;
            _logo = null;
        }
...
class SiteShell {
    ...
    public function prepare( calcDc as EvccDcInterface ) as Void {
        ...
        // Draw the logo
        var logo = new BitmapBlock( Rez.Drawables.logo_evcc, {} as DbOptions );
