...
class SystemInfoView extends WatchUi.View {
    ...
    // debug scope
    (:debug :exclForGlanceNone) function checkFontsDeviceSpecific( block as VerticalBlock, dc as Dc ) as Void {
    ...
    (:debug :exclForGlanceFull :exclForGlanceTiny) function checkFontsDeviceSpecific( block as VerticalBlock, dc as Dc ) as Void {
        checkIcons( new WidgetResourceSet(), block, dc );
    }
...
(:debug :exclForGlanceFull :exclForGlanceNone) class GlanceResourceSet {
    enum Font {
        FONT_GLANCE
    }
